        ...
        <div className="sm:invisible sm:h-0 relative h-[60vh] flex flex-col justify-between items-start">
            ...
            <div className="z-20 w-full flex justify-center items-center my-5">
                <div className="w-[420px] mx-8 flex justify-between items-center bg-[rgba(0,0,0,0.3)]">
                    ...
                    <div onClick={playEvent} className="px-2 py-0 rounded font-bold text-black bg-white cursor-pointer"><i className="bi bi-play-fill"></i> Play</div>
                    <div className="flex flex-col items-center cursor-pointer">
        ...
        <div className="invisible h-0 relative sm:visible sm:h-[60vh] md:h-[70vh] lg:h-[80vh] mx-5 flex flex-col justify-center items-start" >
            ...
            <div className="z-10">
                <figure className="flex items-center">
                    <img className="w-[10px] h-4 mx-2 N_logo" src={sm_logo} alt="logo img"></img><span className="tracking-[8px] text-gray-300"> FILM </span>
                </figure>
                ...
                <div className="w-full loop flex justify-between overflow-y-hidden overflow-x-scroll">
                {
                    Data2.map((curElem, index)=>{
                        return (<div key={index}  >
                            <img onDoubleClick={playEvent} id={curElem.id} onClick={()=>clickedEvent2(curElem.id) } className="img min-w-[150px] h-[200px] rounded px-3 mx-0 py-1" src={curElem.logo} alt="image"></img>
                        </div>)
                    })
                }
                </div>
            ...
            <div id="loop_container">
                ...
                <div className="loop flex overflow-y-hidden overflow-x-scroll">
                {
                    Data.map((curElem, index)=>{
                        return (<div key={index}  >
                            <img onDoubleClick={playEvent} id={curElem.id} onClick={()=>clickedEvent(curElem.id) } className="img min-w-[130px] h-[200px] rounded mx-3 my-1" src={curElem.logo} alt="image"></img>
                        </div>)
                    })
                }
                </div>
